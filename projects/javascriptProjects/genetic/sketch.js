  ...
  for (var i = numMoves; i >= 0; i--) {
    ...
    if(!this.win && !this.lose){
      ...
      for (var j = objects.length - 1; j >= 0; j--) {
        if(this.pos.x > objects[j][0][0] && this.pos.x < objects[j][1][0] && this.pos.y > objects[j][0][1] && this.pos.y < objects[j][1][1])
        {
        this.lose = true;
       
        }

        if(this.pos.x > objects[j][1][0] && this.pos.x < objects[j][0][0] && this.pos.y > objects[j][1][1] && this.pos.y < objects[j][0][1])
        {
        this.lose = true;
